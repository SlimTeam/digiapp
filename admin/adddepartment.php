...
if(strlen($_SESSION['alogin'])==0) {   
    ...
    if(isset($_POST['add'])) {
        ...
        $sql = "INSERT INTO tbldepartments(DepartmentName, DepartmentShortName, DepartmentCode) VALUES(:deptname, :deptshortname, :deptcode)";
        ...
        if($lastInsertId) {
            $msg = "Le service a été créé avec succès.";
        } else {
...
<html lang="fr">
    <head>
        <title>DigiApp Services | Ajouter un service</title>
    ...
    <body>
        ...
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title">Ajouter un nouveau service</div>
                </div>
                <div class="col s12 m12 l6 offset-l3">
                    <div class="card">
                        <div class="card-content">
                            <span class="card-title" style="color: #00838f; font-weight: bold;">Informations du service</span>
                                ...
                                <form class="col s12" name="chngpwd" method="post">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            ...
                                            <label for="departmentshortname">Nom court (Abléviation)</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input id="deptcode" type="text" class="validate" autocomplete="off" name="deptcode" required>
