...
<html lang="fr">
    <head>
        <title>DigiApp Services | Congés refusés</title>
    ...
    <body>
        ...
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title">Historique des congés refusés</div>
                </div>
                
                <div class="col s12 m12 l12">
                    <div class="table-modern-wrapper">
                        <div class="table-modern-title">Liste des demandes refusées</div>
